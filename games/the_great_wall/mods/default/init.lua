...
-- Smoke test upstream désactivé dans Lumia : sur le serveur dédié, un éventuel
-- flag résiduel ne doit jamais provoquer un request_shutdown() pendant le
-- bootstrap monde.
if minetest.settings:get_bool("minetest_game_smoke_test") then
	minetest.log("warning",
		"[default] minetest_game_smoke_test ignoré dans Lumia runtime")
end
